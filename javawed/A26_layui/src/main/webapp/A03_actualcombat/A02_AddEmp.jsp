...
<div>
    <form class="layui-form" action="">
        ...
        <div><input type="hidden" name="Servlet_Add_Delete_Update_Emp" value="Add"></div>

        <div class="layui-form-item">
            <label class="layui-form-label">ID</label>
            <div class="layui-input-block">
                <input type="text" name="id" required lay-verify=”number” placeholder="请输入ID" autocomplete="off"
                       class="layui-input">
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-form-item">
                <div class="layui-input-block">
<%--                  设置 lay-submit lay-filter="AddEmp"为下面 form.on('submit(AddEmp)',使用  --%>
